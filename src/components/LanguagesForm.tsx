    ...
    <div className="space-y-6">
      <div role="list" className="space-y-3">
        {data.map(lang => (
          <div
            key={lang.id}
            className={`p-4 border rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 ${draggingId === lang.id ? 'opacity-60' : ''}`}
            draggable
            onDragStart={e => {
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center">
                ...
                <h3 className="font-medium dark:text-white">{t.language}</h3>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                <label htmlFor={`language-level-${lang.id}`} className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-200">
                  {t.proficiency}
                </label>
                <select
