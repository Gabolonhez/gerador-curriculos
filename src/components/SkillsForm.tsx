    ...
    <div className="space-y-6">
      <div role="list" className="space-y-3">
        {data.map(skill => (
          <div
            key={skill.id}
            className={`p-4 border rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 ${draggingId === skill.id ? 'opacity-60' : ''}`}
            draggable
            onDragStart={e => {
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center">
                ...
                <h3 className="font-medium dark:text-white">{t.skill}</h3>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                <label htmlFor={`skill-level-${skill.id}`} className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-200">
                  {t.level}
                </label>
                <select
